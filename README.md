...
```
## Description
A Django application built using [the tutorial](https://docs.djangoproject.com/en/3.1/intro/tutorial01/#) provides quite the solid base for a secure web application. I chose five flaws from the OWASP top 10 2021 list. Several of these required me to put in some work and thought to expose some vulnerabilities!
...
___
2. [Identification and Authentication Failures](https://owasp.org/Top10/A07_2021-Identification_and_Authentication_Failures/) 
